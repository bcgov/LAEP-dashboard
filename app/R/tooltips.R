tooltips = list(
  ...
  top_employment = HTML("This is a simple ranking of employment by industry,
  ...
  top_lq = HTML("The location quotient measures an industry’s concentration of local jobs,
